...
from invenio.modules.access.api import find_possible_roles, get_roles_emails
...
def acc_authorize_action(req, name_action, authorized_if_no_roles=False,
    ...
    roles_list = find_possible_roles(
...
def acc_get_authorized_emails(name_action, **arguments):
    ...
    @rtype: set of string
    """
    roles = find_possible_roles(name_action, always_add_superadmin=False,
                                **arguments)
    authorized_emails = get_roles_emails(roles)
