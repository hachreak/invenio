...
from invenio.modules.access.local_config import DEF_AUTHS, DEF_ROLES, \
    DEF_USERS, SUPERADMINROLE
...
def delete_all_settings():
    ...
    models.AccROLE.query.delete()
    models.AccACTION.query.delete()
    models.AccARGUMENT.query.delete()
    models.UserAccROLE.query.delete()
    models.AccAuthorization.query.delete()
